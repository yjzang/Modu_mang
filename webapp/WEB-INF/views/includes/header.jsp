						...
						<li class="nav-item menuTab dropdown"><a
							...
							<div class="dropdown-menu"
								...
								<a class="dropdown-item"
									href="${pageContext.request.contextPath }/annualreport?groupNo=${gvo.groupNo}">연간</a>
								<a class="dropdown-item"
									href="${pageContext.request.contextPath }/monthlyreport?groupNo=${gvo.groupNo}">월간</a>
								<div class="dropdown-divider"></div>
								<a class="dropdown-item"
									href="${pageContext.request.contextPath }/eventreport?groupNo=${gvo.groupNo}">행사별</a>
							</div></li>
						<%--게시판--%>
						<li id="btn_board" class="nav-item menuTab"><a
							class="nav-link"
							href="${pageContext.request.contextPath }/board?groupNo=${gvo.groupNo}"
							onclick="btn_board()">게시판</a></li>
						<%--회비관리--%>
						<li class="nav-item menuTab"><a class="nav-link"
							href="${pageContext.request.contextPath }/membershipfee?groupNo=${gvo.groupNo}">회비관리</a>
						</li>
						<%--모임관리--%>
						<li class="nav-item menuTab"><a class="nav-link"
							href="${pageContext.request.contextPath }/groupmanage?groupNo=${gvo.groupNo}">모임관리</a></li>
					</ul>
				</div>
